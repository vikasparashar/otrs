...
$query2 = "select tsk.id,tsk.task,cust.name,cust.customer_id,tsk.status,tsk.Engineer_name from $nameid[1] tsk ,customer_company cust where tsk.customer_name=cust.customer_id and tsk.status !='close'";
...
#  print "$row2[0]-->$row2[1]-->$row2[2]\n";
      ...
      my $file = "mesg.txt";
      open (MYFILE, ">>$file");
print MYFILE "<tr><td width='10px' height='10px'>$row2[0]</td><td width='10px' height='10px'>$row2[2]</td><td width='10px' height='10px'></td><td width='10px' height='10px'>Onsite</td><td width='10px' height='10px'>$row2[1]</td><td width='10px' height='10px'>$row2[4]</td><td width='10px' height='10px'>$row2[5]</td></tr>";
#      close (MYFILE);
#      $sub=$;
}
close(MYFILE);
...
$body
<tr><td width='10px' height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td></tr>
<tr><td width='10px' height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td></tr>
<tr><td width='10px' height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td></tr>
<tr><td width='10px' height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td></tr>
<tr><td width='10px' height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td><td width='10px'  height='10px'></td></tr>
...
<br><br><br><br>
<h3><font color='red'>Please Update it at end of day(Use Same Format above)<br>
If you Have any new task,Please fill all blank field For ex.(Date-->16-07-2014,Customer-->CDOT,Ticket-->sort of task,status-->close/pending/approval for pending,Engineer-name-->Piyush Mishra.(Except id column))</font></h3><br>
<h4>Thanks</h4><br>
